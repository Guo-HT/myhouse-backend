...
class Essay(models.Model):
    ...
    user = models.ForeignKey("UserManagement.User", blank=True, null=True, on_delete=models.DO_NOTHING, verbose_name="上传用户")
...
class EssayComment(models.Model):
    ...
    from_essay = models.ForeignKey("Essay", blank=True, null=True, on_delete=models.CASCADE, verbose_name="文章")
    good_num = models.IntegerField(default=0, verbose_name="点赞量")
    user = models.ForeignKey("UserManagement.User", blank=True, null=True, verbose_name="发表用户", on_delete=models.DO_NOTHING)
...
class GoodList(models.Model):
    user = models.ForeignKey("UserManagement.User", blank=False, null=False, on_delete=models.CASCADE, verbose_name="点赞用户")
    essay = models.ForeignKey("Essay", blank=False, null=False, on_delete=models.CASCADE, verbose_name="点赞文章")
...
class BrowseHistory(models.Model):
    user = models.ForeignKey("UserManagement.User", blank=True, null=True, on_delete=models.CASCADE, verbose_name="用户")
    essay = models.ForeignKey("Essay", blank=False, null=False, on_delete=models.CASCADE, verbose_name="浏览文章")
...
class EssayCollection(models.Model):
    user = models.ForeignKey("UserManagement.User", blank=True, null=True, on_delete=models.CASCADE, verbose_name="用户")
    essay = models.ForeignKey("Essay", blank=False, null=False, on_delete=models.CASCADE, verbose_name="收藏文章")
